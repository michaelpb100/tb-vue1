<template>
  <div id="app">
    ...
    <lightbox ref="lightbox" :images="images" :filter="galleryFilter" :timeoutDuration="5000"></lightbox>
  </div>
</template>

<script>
  const imageList = [
    { name: "Trailer_1.jpg", alt: "The Dolomites", filter: "nature", id: "image1" },
  ...
  export default {
    ...
    data() {
      return {
        thumbnailDir: process.env.BASE_URL + "images/",
        images: imageList,
        galleryFilter: "all"
      };
    },
